...
public class RegisterRepo implements IFragUserRegisterContract.register_repo {
    ...
    public RegisterRepo(String name, String shopname, String mobileno, String email, String address, String upiid, String panno, String gstno, String password, String confirmpassword) {
        this.name = name;
