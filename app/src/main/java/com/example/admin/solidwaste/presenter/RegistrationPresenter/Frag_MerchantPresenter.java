...
import com.example.admin.solidwaste.models.Login.Registration.RegisterRepo;
...
public class Frag_MerchantPresenter
        extends BasePresenter<IFragUserRegisterContract.view> implements IFragUserRegisterContract.merchantpresenter {
    ...
    @Inject
    Frag_MerchantPresenter(IFragUserRegisterContract.view view) {
        super(view);
        this.view = view;
    }

    @Override
    public void onValidate(String name, String shopname, String mobileno, String email, String address, String upiid, String panno, String gstno, String password, String confirmpassword) {
        RegisterRepo user = new RegisterRepo(name, shopname, mobileno, email, address, upiid, panno, gstno, password, confirmpassword);
        ...
        switch (isLoginSuccess) {
            ...
            case 6: {
                view.onError("Enter pan No");

                break;
            }
            case 7: {
                view.onError("Enter Gst No");
    ...
    @Override
    public void registerMerchant(String name, String email, String password, String city, String address, String firebaseid, String latlng, String nameofshop, String gstno, String upiid, String panno, String mobileno, String typeofuser, SharedPreferences sharedPreferences, NetworkClient networkClient, Retrofit retrofit) {
